...
<center>
 ...
 <form action="update.php" method="post" style="max-width:500px;margin:auto">
  ...
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="text" value="<?php echo $_SESSION['name']?>" name="name">
  </div>
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="password" value="<?php echo $_SESSION['password']?>" name="psw">
  </div>

  <div class="input-container">
    <i class="fa fa-address-card icon"></i>
    <input class="input-field" type="text" value="<?php echo $_SESSION['address']?>" name="address">
  </div>

    <div class="input-container">
      <i class="fa fa-mobile-phone icon"></i>
      <input class="input-field" type="text" value="<?php echo $_SESSION['phone']?>" name="phone">
    </div>
    <div class="input-container">
      <i class="fa fa-envelope icon"></i>
